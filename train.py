...
def main(config):
    ...
    # data
    tr_dataset = AudioDataset(json_dir=config["train_dataset"]["train_dir"],       # The directory contains mix.json, s1.json, s2.json
                              batch_size=config["train_dataset"]["batch_size"],
                              sample_rate=config["train_dataset"]["sample_rate"],  # Sampling Rate
                              segment=config["train_dataset"]["segment"],         # Voice duration in sec
                              cv_max_len=config["train_dataset"]["cv_max_len"])
