...
class Encoder(nn.Module):
    ...
    def __init__(self, L, N):
        ...
        """
            Learn STFT-like representations.
            The stride factor of the convolution has a significant impact on the performance, speed and memory of the model.
        """

        super(Encoder, self).__init__()

        self.L = L  # Convolution kernel size
...
class Separator(nn.Module):
    ...
    def __init__(self, N, C, H, K, Global_B, Local_B):
        ...
        self.C = C
        self.K = K
        self.Global_B = Global_B  #Global loop times
        self.Local_B = Local_B  # local loop times
    ...
    def split_feature(self, input, segment_size):
        ...
        # Split features into segment-sized chunks
    ...
    def merge_feature(self, input, rest):
        ...
        # Merge segmented features into complete utterances
...
class Sepformer(nn.Module):
    ...
    def __init__(self, N=64, C=2, L=4, H=4, K=250, Global_B=2, Local_B=4):
        ...
        self.N = N               # Encoder output channel
        self.C = C               # Number of separate sources
        self.L = L               # Encoder convolution kernel size
        self.H = H               # Pay attention to the number of headers
        self.K = K               # chunk size
        self.Global_B = Global_B # Number of global loops
        self.Local_B = Local_B   # Number of local loops
    ...
    def forward(self, x):
        ...
        # Encoding
        x, rest = self.pad_signal(x)  # zero padding，torch.Size([1, 1, 32006])
